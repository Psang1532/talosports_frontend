      ...
      <div className="wallet-grid">
        ...
        <div className="wallet-card-demo">
          ...
          <div className="wallet-demo-balance">
            ...
            <div className="wallet-demo-bal-sub">
              ≈ $2,196 USD · Updated live
            </div>
          </div>
          <div className="wallet-demo-txns">
            {[
              {
                label: "Safaricom Sponsorship Q1",
                amount: "+KES 120,000",
                dir: "in",
              },
              { label: "Merchandise sales", amount: "+KES 48,200", dir: "in" },
              {
                label: "Transfer fee share",
                amount: "+KES 116,300",
                dir: "in",
              },
        ...
        {/* Feature list */}
        <div>
          <p className="sec-label" style={{ color: "var(--gold)" }}>
            Athlete Monetisation
          </p>
          <h2
            className="sec-title light"
            style={{ color: "#fff", marginBottom: "0.8rem" }}
          >
            Your wallet.
            <br />
            <em>Your earnings.</em>
          ...
          <p className="sec-sub light" style={{ marginBottom: "2.5rem" }}>
            Every deal, sponsorship, ticket and merchandise sale flows directly
            into your TALO wallet — with instant mobile-money payouts across
            Africa.
          </p>
            ...
            {[
              {
                ...
                desc: "Hold KES, NGN, GHS, ZAR, USD , TZS, ZAR, RWF and more.",
              },
              {
                title: "Mobile Money Payouts",
                desc: "Withdraw to  Mobile Money or your bank in minutes.",
              },
              {
                title: "Revenue Streams Dashboard",
                desc: "Track sponsorship income, transfer fees, merchandise and fan revenue in one view.",
              },
              {
                title: "Escrow-Protected Deals",
                desc: "All deals are held in escrow until conditions are met. No more late payments.",
              },
            ].map((f) => (
