// src/components/advisory/AdvisoryIcons.tsx
// Centralised SVG icons used across advisory components

interface IconProps {
  className?: string;
}

export function IconExcellence({ className }: IconProps) {
  return (
    <svg className={className} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5">
      <circle cx="12" cy="12" r="3" />
      <path d="M12 2v3m0 14v3M2 12h3m14 0h3M4.22 4.22l2.12 2.12m11.32 11.32 2.12 2.12M4.22 19.78l2.12-2.12m11.32-11.32 2.12-2.12" />
    </svg>
  );
}
...
export function IconCommercial({ className }: IconProps) {
  return (
    <svg className={className} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5">
      <path d="M17 20.5H7A2.5 2.5 0 0 1 4.5 18v-1a5 5 0 0 1 5-5h5a5 5 0 0 1 5 5v1a2.5 2.5 0 0 1-2.5 2.5Z" />
...
export function IconValuation({ className }: IconProps) {
  return (
    <svg className={className} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5">
...
export function IconRights({ className }: IconProps) {
  return (
    <svg className={className} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5">
